...
Pomegranate is an open-source processor design framework for rapid prototyping and education. It provides a library of validated portable and scalable VHDL modules that allow you to quickly experiment with various architectural designs.
...
* **Configuration Packages** - Easily configure core architectural elements :
    * [Instruction Set Config](/config/pomegranate_inst_conf.vhd) - Define your Instruction Set Architecture (ISA), this can be a custom ISA or a pre-defined one like [RISCV](https://github.com/riscv).
    * [Memory Map Config](/config/pomegranate_memory_map_conf.vhd) - Define memory-mapped peripherals and partition your memory.
* **Portable and Scalable** - All modules are designed to be compatible with as many FPGA platforms as possible, they can also be scaled.
